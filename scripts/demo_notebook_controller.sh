...
#
# Usage: bash scripts/demo_notebook_controller.sh
#
...
SCRIPT="scripts/notebook_controller.py"
...
echo ""
echo "  python scripts/notebook_automation_examples.py 1   # Basic Navigation"
echo "  python scripts/notebook_automation_examples.py 2   # Search & Analyze"
echo "  python scripts/notebook_automation_examples.py 3   # Cell Manipulation"
echo "  python scripts/notebook_automation_examples.py 4   # Undo/Redo"
echo "  python scripts/notebook_automation_examples.py 5   # Batch Operations"
echo "  python scripts/notebook_automation_examples.py 6   # Output Management"
echo "  python scripts/notebook_automation_examples.py 7   # Export/Import"
echo "  python scripts/notebook_automation_examples.py 8   # Validation"
echo "  python scripts/notebook_automation_examples.py all # All examples"
echo ""
read -p "Press Enter to continue..."
echo ""
...
echo ""
echo "  python scripts/notebook_controller.py $NOTEBOOK"
echo ""
...
echo ""
echo "📚 Documentation:"
echo "  - Quick Start: docs/NOTEBOOK_CONTROLLER_QUICKSTART.md"
echo "  - Full Guide:  docs/NOTEBOOK_CONTROLLER_GUIDE.md"
echo "  - README:      scripts/README_NOTEBOOK_CONTROLLER.md"
echo ""
echo "🧪 Try it yourself:"
echo "  python scripts/notebook_controller.py $NOTEBOOK"
echo ""
echo "❓ Get help:"
echo "  python scripts/notebook_controller.py --help"
echo ""
